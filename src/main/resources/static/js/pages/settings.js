...
let htmlEstructura = `
    ...
    @media (max-width: 768px) {
        ...
        .sg-body { 
            flex: 1 !important; 
            padding: 20px 20px 180px 20px !important; /* 180px de aire para que no se corte el botón */
        ...
        .sg-save-btn {
            margin-bottom: 40px !important; /* Más aire abajo del propio botón */
        }
    }
    </style>
